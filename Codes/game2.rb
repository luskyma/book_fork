...
weapon = ask_question("awesome lets get your sidekick a weapon to defend themselves?", "options: batarang, fists, flashlight?")
...
# refer to the method puts setup "your options are #{options}" to delete these lines "Options : Joker, Penguin, Riddler"
